...
INSERT INTO f_dw_produit(isbn,titre,auteur,langue,publication,editeur,genre) (
SELECT t.getIsbn(),t.getTitre(),t.getAuteur(),t.getLangue(),t.getPublication(),t.getEditeur(), t.getGenre()
...
INSERT INTO f_dw_ventes (ticket, mag,dat,pro)
SELECT t.getTicket(), t.getMagasin(),t.getDate(),t.getIsbn()
FROM f_bdt_ventes t;
